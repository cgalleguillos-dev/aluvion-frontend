...
interface Props {
  valves: ResponseComposeComponent[];
  selectedValve: ResponseComposeComponent;
  setValveSelected: (valve: ResponseComposeComponent) => void;
}

export const ValvesHeaderView: React.FC<Props> = ({ valves, selectedValve, setValveSelected }) => {

  const handleSelectValve = (valve: ResponseComposeComponent) => {
