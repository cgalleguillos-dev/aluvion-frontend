  ...
  return (
    <div className="w-64 h-screen bg-slate-100 text-slate-300 selection:bg-blue-600 selection:text-white">
      <div className="flex flex-col">
        <div id="menu" className="z-10 w-64 h-screen min-h-screen bg-gray-900 text-slate-300 ">
          ...
          <div id="nav" className="w-full px-6">
            ...
            <Link href="/homes/logout" className="inline-flex items-center w-full px-2 py-3 space-x-2 transition duration-150 ease-linear hover:bg-white/5">
              <div className="flex flex-col">
